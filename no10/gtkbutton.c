...
int main (int argc, char *argv[]) {
	...
	add_widget_with_label ( GTK_CONTAINER(vbox), "체크 버튼:", checkbutton);
	add_widget_with_label (GTK_CONTAINER(vbox), "토글 버튼:", togglebutton);
	add_widget_with_label (GTK_CONTAINER(vbox), "라디오 버튼 1:", radiobutton1);
	add_widget_with_label (GTK_CONTAINER(vbox), "라디오 버튼 2:", radiobutton2);
